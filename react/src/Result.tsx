...
=======
    ...
    return (
        <div>
            ...
            <p className=" text-center font-custom2">{info.description}</p>
            {/* 추천 음악 */}
            <div className="mb-5">
                <Playlist />
                <Music />
            ...
            <span className=" flex justify-center m-12 text-xl font-bold font-custom">내 결과 공유하기</span>
...
>>>>>>> jihee
        ...
        <div className="absolute top-[594px] w-full flex flex-col items-center justify-center">
          ...
          <span className="absolute top-[120px] left-0 w-full h-full text-4xl font-custom1">
            {title}
          </span>
        </div>
      </div>
      {/* 성향 설명 */}
      <div className="text-center font-custom2">
