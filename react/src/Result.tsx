...
const resultInfo = [
  {
    ...
    img: zeus,
    thumbnail:
      'https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/zeus.jpg',
  ...
  },
  {
    ...
    img: ares,
    thumbnail:
      'https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/ares.jpg',
  ...
  },
  {
    ...
    img: apollon,
    thumbnail:
      'https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/apollon.jpg',
  ...
  },
  {
    ...
    img: hermes,
    thumbnail:
      'https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/hermes.jpg',
  ...
  },
  {
    ...
    img: athena,
    thumbnail:
      'https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/athena.jpg',
    description:
  ...
  },
  {
    ...
    img: artemis,
    thumbnail:
      'https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/artemis.jpg',
    description:
  ...
  },
  {
    ...
    img: demeter,
    thumbnail:
      'https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/demeter.jpg',
    description:
  ...
  },
  {
    ...
    img: hestia,
    thumbnail:
      'https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/hestia.jpg',
    description:
...
const Result: React.FC = () => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src =
      'https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/linkRound.svg';
  }, []);
    ...
    const incCount = async () => {
      try {
        const response = await axios.post(
          'https://api2.indj.club/event/api/insertMBTILog',
          { type: 3 }
        );
  ...
  return (
    <div className="bg-white">
      ...
      <span className=" flex justify-center mt-24 mb-16 text-xl font-bold font-custom2">
        내 결과 공유하기
      </span>
      <div className="flex justify-center space-x-10 bg-white pb-10">
        <img
          src="https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/linkRound.svg"
          onClick={copyLink}
          className="h-[60px] w-[6] mt-[8px] cursor-pointer"
        ></img>
        <img
          src="https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/kakao-talk.png"
          onClick={shareKakaoLink}
          className="h-[60px] w-[60px] mt-[8px] cursor-pointer"
        ></img>
        <img
          src="https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/facebook.png"
          onClick={shareFacebook}
          className="h-[60px] w-[60px] mt-[8px] cursor-pointer"
        ></img>
        <img
          src="https://indj.s3.ap-northeast-2.amazonaws.com/image/event/olympus/xImg.png"
